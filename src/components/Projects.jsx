...
const Projects = () => {
  return (
    ...
    className='gap-12 md:gap-24 justify-between flex flex-col m-auto w-full' >
        ...
        <motion.div viewport={{once:true}} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.5}} className='mx-auto flex flex-col-reverse md:flex-row-reverse justify-center gap-24 w-5/6 select-none z-10 '>
            <Card className="py-4">
            ...
            <Card className="py-4">
                ...
                <CardBody className="overflow-visible py-2">
                    ...
                    alt="Card background"
                    className="object-cover rounded-xl drop-shadow-lg"
                    src="https://imgur.com/DNVc394.png"
                    width={300}
                    />
